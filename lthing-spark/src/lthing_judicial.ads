...
--      ML-DSA-65 signature verification. It returns Trusted = True if and
...
package LTHING_Judicial is
   ...
   --    its chain hash links to Previous_Seal, and its ML-DSA-65 signature
   --    verifies under Public_Key. Equivalently: if ANY check fails, Trusted
   --    is False and Status names the first failing stage.
   ---------------------------------------------------------------------------
